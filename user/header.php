...
<html lang="en">
    ...
    include '../koneksi.php';
    session_start();
    if($_SESSION['status'] != "pegawai_login"){
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="surat_keluar.php"><i class="fa fa-file-text"></i> Surat Keluar</a></li>
             <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-print"></i> Cetak Laporan<b class="caret"></b></a>
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown user-dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['nama']; ?> <b class="caret"></b></a>
              <ul class="dropdown-menu">
