<?php include 'header.php'; ?>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Laporan Surat Keluar</h1>
          </div>
        </div><!-- /.row -->
        <br>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" class="col-lg-12">
                                    <form class="form-horizontal form-label-left" method="post" action="lap_suratkeluar.php" target="_blank">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-offset-3">
                                    <button type="submit" name="cetakk" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Cetak</button>
                                    <a href="cetak_suratkeluar.php?" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                                </div>  
                            </div>
                        </form>
                            </div>
