...
?>
 <div id="page-wrapper">
                ...
                while ($id_user = mysqli_fetch_array($query_data)) {
                ?>
              <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-5">
                               <input type="hidden" name="iduser" value="<?php echo $id_user['id'];?>">
                              <input type="text" class="form-control" name="username" value="<?= $id_user['username']?>" >
                              </div>
                            </div>
                            <div class="form-group row">
                              <label  class="col-sm-2 col-form-label">Nama</label>
                              <div class="col-sm-5">
                                <input type="text" class="form-control" name="nama" value="<?= $id_user['nama']?>" >
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-5">
                                <input type="text" class="form-control" name="level" id="disabledInput" value="<?= $id_user['level']?>" disabled>
                              </div>
                            </div>
