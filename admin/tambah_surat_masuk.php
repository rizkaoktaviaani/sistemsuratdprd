      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-6">
                <form action="proses_tambahsuratmasuk.php" method="post" enctype="multipart/form-data">
                  <div class="container">
                   <div class="form-group row">
                    <div class="form-group row">
                      <label  class="col-sm-2 col-form-label">Tanggal Terima</label>
                      <div class="col-sm-5">
                        <input type="date" class="form-control" name="tgl_terima" id="tanggal" placeholder="" required="">
                      </div>
                    </div>
